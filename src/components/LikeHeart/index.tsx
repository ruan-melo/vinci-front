  ...
  return (
    <div className={`relative ${className || ''}`}>
      ...
      >
        ...
        <svg
          fill={'currentColor'}
          className="group-hover:opacity-0 relative  text-green-600 transition-all duration-200 hover:text-green-800"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
          {/*! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. */}
      ...
      <div onClick={handleLike} className={`group ${liked ? 'hidden' : ''}`}>
        ...
        <svg
          fill={'currentColor'}
          className={
            'absolute  text-transparent group-hover:text-green-600/70 transition-all duration-200 hover:text-green-800'
          }
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
        ...
        <svg
          fill={'currentColor'}
          className="group-hover:text-transparent relative  text-gray-600 transition-all  duration-200"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
          {/*! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. */}
