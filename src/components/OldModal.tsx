        ...
        ReactDOM.createPortal(
          ...
          >
            <div className="fixed inset-0 z-40 flex items-center justify-center"  >
                ...
                <div ref={nodeRef} className="modal relative flex flex-col gap-4 w-full max-w-md px-4 py-6 bg-white rounded-lg shadow-xl">
                  <div className='flex justify-between items-center border-b-2 border-gray-200 pb-2'>
                    <h3>{title}</h3>
                    <div className='flex flex-col gap-2'>
                      <button onClick={onClose} className='p-2 rounded-sm hover:bg-gray-200 transition-all duration-200'>
