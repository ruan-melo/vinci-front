        ...
        <div>
            <div onClick={() => {
                ...
                {post.medias.length > 1 && (
                    <svg  xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} stroke="rgb(156 163 175)" className=" text-white absolute top-0 right-0 -translate-x-1/2 translate-y-1/2 w-6 h-6">
